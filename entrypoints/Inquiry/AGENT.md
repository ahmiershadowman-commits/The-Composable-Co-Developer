# AGENT GUIDE — entrypoints/Inquiry/

Role note: Evidence/explanation/formal investigation family. Assumes the problem can be worked honestly after trust is established.
