# AGENT GUIDE — entrypoints/Forensics/

Role note: Ground-truth family. Build deep-trust entry behavior here before any other family assumes the surface is safe.
